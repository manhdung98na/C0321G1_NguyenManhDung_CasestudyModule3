        ...
        <table class="table table-borderless">
            ...
            <div class="form-group">
                <tr>
                    ...
                    <td>
                        <input type="date" class="form-control d-inline" id="addBirthday" name="employee-birthday"
            ...
            <div class="form-group">
                <tr>
                    ...
                    <td>
                        <input type="number" min="1" class="form-control d-inline" id="addSalary" name="employee-salary"
