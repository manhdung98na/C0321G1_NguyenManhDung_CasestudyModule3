...
<div class="container">
    <div class="card mt-4">
        <div class="card-header">
            <h3 style="color: #c41f00">Tìm kiếm nhân viên theo tên</h3>
        </div>
        <div class="card-body">
            ...
            <div class="d-inline">
                <h5 class="card-title d-inline-block">Danh sách nhân viên</h5>
            </div>
            <table class="table table-sm align-middle table-striped table-bordered mt-4" id="tableEmployee">
                ...
                <tbody>
                <c:forEach items='${searchList}' var="employee">
                    <tr class="">
        ...
        <div class="text-center w-100">
            <a href="/employee" type="button" class="btn btn-dark w-15 ">
                Back
            </a>
        </div>
    </div>
