...
<div class="container">
    <div class="card mt-4">
        <div class="card-header">
            <h3 style="color: #c41f00">Danh sách nhân viên</h3>
        </div>
        <div class="card-body">
            ...
            <a href="/employee?action=add" type="button" class="btn btn-success card-title float-right">
                Add new employee
            </a></div>
        </c:if>
        ...
        <div>
            <div class="search-box">
                <form class="search-form  d-flex" action="/employee" method="post">
        ...
        <div class="d-inline">
                <%--Hiển thị danh sách--%>
            <h5 class="card-title d-inline-block">List of Employees</h5>
            <a href="/employee?action=add" type="button" class="btn btn-success card-title float-right">
                Add new employee
            </a></div>
            <%--Bảng danh sách--%>
        <table class="table table-sm align-middle table-striped table-bordered mt-4" id="tableEmployee">
                <%--tiêu đề của bảng--%>
            ...
            <tr class="">
                ...
                <th class=" text-center">Salary(Triệu/tháng)</th>
                <th class=" text-center">Phone</th>
                <th class=" text-center">Email</th>
                <th class=" text-center">Address</th>
                <th class=" text-center">Position</th>
                <th class=" text-center">Degree</th>
                <th class=" text-center">Divition</th>
            ...
            <c:forEach items='${listemployee}' var="employee">
                <tr class="">
                    ...
                    <td class=" text-center">${employee.getPositionName()}</td>
                    <td class=" text-center">${employee.getEducationDegreeName()}</td>
                    <td class=" text-center">${employee.getDivisionName()}</td>
                    <td class=" text-center">
                        <a class="btn btn-info btn-sm" href="/employee?action=edit&id=${employee.getId()}"
                           role="button">Edit</a>

                        <!-- Button trigger modal -->
                        <button type="button" class="btn btn-danger btn-sm" data-toggle="modal"
                                data-target="#modalDel"
                                onclick="sendInfoToDelete('${employee.getId()}','${employee.getName()}')">
                            Delete
                        </button>
                        <!-- Modal -->
