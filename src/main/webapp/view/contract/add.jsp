                ...
                <table class="table table-borderless">
                    ...
                    <div class="form-group">
                        <tr>
                            ...
                            <td>
                                <input type="date" class="form-control d-inline" id="addStartDate"
                    ...
                    <div class="form-group">
                        <tr>
                            ...
                            <td>
                                <input type="date" class="form-control d-inline" id="addEndDate"
                    ...
                    <div class="form-group">
                        <tr>
                            ...
                            <td>
                                <input type="number" min="0" class="form-control d-inline" id="addDeposit"
                    ...
                    <div class="form-group">
                        <tr>
                            ...
                            <td>
                                <input type="number" min="0" class="form-control d-inline" id="addTotalMoney"
                                       name="contract-total-money"
                    ...
                    <div class="form-group">
                        <tr>
                            ...
                            <td>
                                <input type="number" min="0" class="form-control d-inline" id="addEmployID"
                    ...
                    <div class="form-group">
                        <tr>
                            ...
                            <td>
                                <input type="text" class="form-control d-inline" id="addCustomerID"
                    ...
                    <div class="form-group">
                        <tr>
                            ...
                            <td>
                                <input type="text" class="form-control d-inline" id="addServiceID"
